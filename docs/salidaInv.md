...
## `Method GET` /getEncSalidaInvList
...
```
## `Method DELETE` /deleteEncSalidaInv/{idEncSalidaInv}
...
## `Method GET` /getDetSalidaInvList
...
```
## `Method DELETE` /deleteDetSalidaInv/{idDetSalidaInv}
